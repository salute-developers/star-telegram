...
public class Camera2Enumerator implements CameraEnumerator {
  ...
  @Nullable
  public android.graphics.Rect getActiveSensorArea(String deviceName) {
    CameraCharacteristics characteristics = getCameraCharacteristics(deviceName);
  ...
  public boolean isHalCropAvailable(String deviceName) {
    ...
    return characteristics != null && characteristics.getAvailableSessionKeys() != null
            && characteristics.getAvailableSessionKeys().contains(sourceResolutionKey);
  }
