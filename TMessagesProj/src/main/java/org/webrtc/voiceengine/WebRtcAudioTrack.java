...
public class WebRtcAudioTrack {
  ...
  private int initPlayout(int sampleRate, int channels, double bufferSizeFactor) {
    ...
    SbdvServiceLocator.getHdmiRouteEnforcerSharedInstance().setAudioRouting(audioTrack);
  ...
  private boolean stopPlayout() {
    ...
    try {
      SbdvServiceLocator.getHdmiRouteEnforcerSharedInstance().clearAudioRouting();
      releaseAudioResources();
    } catch (Throwable e) {
      FileLog.e(e);
    }
