...
public class Camera2Capturer extends CameraCapturer {
  ...
  @Nullable private Camera2Session session = null;
  ...
  protected void createCameraSession(CameraSession.CreateSessionCallback createSessionCallback,
      ...
      int framerate) {
    session = Camera2Session.create(createSessionCallback, events, applicationContext, cameraManager,
