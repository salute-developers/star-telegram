...
public class DownloadController extends BaseController implements NotificationCenter.NotificationCenterDelegate {
    ...
    public DownloadController(int instance) {
        ...
        if ((newConfig = preferences.contains("newConfig")) || !getUserConfig().isClientActivated()) {
            mobilePreset = new Preset(preferences.getString("mobilePreset", defaultMedium), defaultLow);
            wifiPreset = new Preset(preferences.getString("wifiPreset", defaultHigh), defaultLow);
