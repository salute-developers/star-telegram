...
import static org.telegram.messenger.BuildVars.LOGS_ENABLED;
...
public class NotificationCenter {
    ...
    public static final int sbdv_onUserAvatarChanged = totalEvents++;
    public static final int sbdv_onUserNameChanged = totalEvents++;
    public static final int sbdv_onUserAdded = totalEvents++;
    public static final int sbdv_onUserRemoved = totalEvents++;
    ...
    public void postNotificationName(int id, Object... args) {
        if (LOGS_ENABLED) {
            ...
            if (notification != null) {
                Log.d("NotificationCenter", "postNotificationName(): " + notification.name());
            }
        }
