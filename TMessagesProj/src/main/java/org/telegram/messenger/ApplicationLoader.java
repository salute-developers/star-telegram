...
import ru.sberdevices.telegramcalls.vendor.util.InitLoggerKt;
...
public class ApplicationLoader extends Application {
    ...
    public static void postInitApplication() {
        ...
        try {
            ...
            BroadcastReceiver networkStateReceiver = new BroadcastReceiver() {
                ...
                public void onReceive(Context context, Intent intent) {
                    Log.d(TAG, "CONNECTIVITY_ACTION onReceive");

                    try {
                        currentNetworkInfo = connectivityManager.getActiveNetworkInfo();
                    } catch (Throwable thr) {
                        Log.w(TAG, "Failed to get info about active networks", thr);
                    }
        ...
        for (int a = 0; a < UserConfig.MAX_ACCOUNT_COUNT; a++) { //TODO improve account
            Log.d("ApplicationLoader", "checkAppAccount()");
        ...
        SbdvServiceLocator.getAuthorizationFeatureSharedInstance().refreshProfiles();
    }
