...
public final class Instance {
    ...
    public static NativeInstance makeInstance(String version, Config config, String persistentStateFilePath, Endpoint[] endpoints, Proxy proxy, int networkType, EncryptionKey encryptionKey, VideoSink remoteSink, long videoCapturer, NativeInstance.AudioLevelsCallback audioLevelsCallback, NativeInstance.CodecsSelectedCallback codecsSelectedCallback) {
        if (!"2.4.4".equals(version)) {
            ContextUtils.initialize(ApplicationLoader.applicationContext);
        }
        instance = NativeInstance.make(version, config, persistentStateFilePath, endpoints, proxy, networkType, encryptionKey, remoteSink, videoCapturer, audioLevelsCallback, codecsSelectedCallback);
    ...
    public static final class FinalState {
        ...
        public FinalState(byte[] persistentState,
                          String debugLog,
                          TrafficStats trafficStats,
                          boolean isRatingSuggested,
    ...
    public static final class VideoStats {
        ...
        public final int avgEncodeTimeMs;

        public final int framesEncoded;
        public final int framesDroppedByCapturer;
        public final int framesDroppedByEncoderQueue;
        public final int framesDroppedByRateLimiter;
        public final int framesDroppedByCongestionWindow;
        public final int framesDroppedByEncoder;
        ...
        public VideoStats(
                ...
                int avgEncodeTimeMs,
                int framesEncoded,
                int framesDroppedByCapturer,
                int framesDroppedByEncoderQueue,
                int framesDroppedByRateLimiter,
                int framesDroppedByCongestionWindow,
            ...
            this.framesDroppedByCapturer = framesDroppedByCapturer;
            this.framesDroppedByEncoderQueue = framesDroppedByEncoderQueue;
            this.framesDroppedByRateLimiter = framesDroppedByRateLimiter;
            this.framesDroppedByCongestionWindow = framesDroppedByCongestionWindow;
            this.framesDroppedByEncoder = framesDroppedByEncoder;
        }
        ...
        public String toString() {
            return "VideoStats{" +
                    ...
                    ", avgEncodeTimeMs=" + avgEncodeTimeMs +
                    ", framesEncoded=" + framesEncoded +
                    ", framesDroppedByCapturer=" + framesDroppedByCapturer +
                    ", framesDroppedByEncoderQueue=" + framesDroppedByEncoderQueue +
                    ", framesDroppedByRateLimiter=" + framesDroppedByRateLimiter +
                    ", framesDroppedByCongestionWindow=" + framesDroppedByCongestionWindow +
