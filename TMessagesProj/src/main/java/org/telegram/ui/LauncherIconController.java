...
public class LauncherIconController {
    ...
    public enum LauncherIcon {
        DEFAULT("DefaultIcon", R.drawable.icon_background_sa, R.mipmap.icon_3_foreground_sa, R.string.AppIconDefault),
        VINTAGE("VintageIcon", R.drawable.icon_6_background_sa, R.mipmap.icon_6_foreground_sa, R.string.AppIconVintage),
        AQUA("AquaIcon", R.drawable.icon_4_background_sa, R.mipmap.icon_3_foreground_sa, R.string.AppIconAqua),
        ...
        NOX("NoxIcon", R.mipmap.icon_2_background_sa, R.mipmap.icon_3_foreground_sa, R.string.AppIconNox, true);
