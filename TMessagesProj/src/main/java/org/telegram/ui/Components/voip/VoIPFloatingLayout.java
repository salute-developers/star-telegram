...
public class VoIPFloatingLayout extends FrameLayout {
    ...
    public float relativePositionToSetX = VoIPFragment.SbdvVoipDimensions.pipPositionX;
    float relativePositionToSetY = VoIPFragment.SbdvVoipDimensions.pipPositionY;
    ...
    public VoIPFloatingLayout(@NonNull Context context) {
        ...
        mutedDrawable = ContextCompat.getDrawable(context, R.drawable.sbdv_ic_microphone_off_white);
    }
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        canvas.drawCircle(cX, cY, VoIPFragment.SbdvVoipDimensions.notificationIconSize, mutedPaint);
    ...
    public void saveRelativePosition() {
        savedRelativePositionX = VoIPFragment.SbdvVoipDimensions.pipPositionX;
        savedRelativePositionY = VoIPFragment.SbdvVoipDimensions.pipPositionY;
    }
    ...
    public void restoreRelativePosition() {
        ...
        if (savedRelativePositionX >= 0 && !switchingToFloatingMode) {
            savedRelativePositionX = VoIPFragment.SbdvVoipDimensions.pipPositionX;
            savedRelativePositionY = VoIPFragment.SbdvVoipDimensions.pipPositionY;
            setRelativePositionInternal(VoIPFragment.SbdvVoipDimensions.pipPositionX, VoIPFragment.SbdvVoipDimensions.pipPositionY, getMeasuredWidth(), getMeasuredHeight(), true);
        }
    }
}
