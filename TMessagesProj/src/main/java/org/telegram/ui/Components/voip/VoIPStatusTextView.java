...
public class VoIPStatusTextView extends FrameLayout {
    ...
    public VoIPStatusTextView(@NonNull Context context, VoIPBackgroundProvider backgroundProvider) {
        ...
        for (int i = 0; i < 2; i++) {
            ...
            textView[i].setTextSize(TypedValue.COMPLEX_UNIT_DIP, VoIPFragment.SbdvVoipDimensions.subtitleTextSize);
        ...
        reconnectTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, VoIPFragment.SbdvVoipDimensions.subtitleTextSize);
    ...
    private void replaceViews(View out, View in, Runnable onEnd) {
        ...
        in.setTranslationY(AndroidUtilities.dp(VoIPFragment.SbdvVoipDimensions.subtitleTextSize));
        in.setAlpha(0f);
