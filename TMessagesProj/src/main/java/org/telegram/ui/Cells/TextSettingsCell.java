...
public class TextSettingsCell extends FrameLayout {
    ...
    public TextSettingsCell(Context context) {
        this(context, TelegramDimensions.getSelectCountryItemTextSize());
    }
    ...
    public TextSettingsCell(Context context, int padding, Theme.ResourcesProvider resourcesProvider) {
        ...
        params.setMargins(32, TelegramDimensions.selectSize( 6 , 8), 0, TelegramDimensions.selectSize( 6 , 8));
        setLayoutParams(params);
        this.resourcesProvider = resourcesProvider;
        this.padding = padding;

        textView = new TextView(context);
        textView.setTextSize(TypedValue.COMPLEX_UNIT_DIP, TelegramDimensions.getSelectCountryItemTextSize());
        textView.setLines(1);
        ...
        valueTextView.setTextColor(context.getResources().getColor(R.color.sbdv_green_light));
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        setMeasuredDimension(
                ...
                AndroidUtilities.dp(TelegramDimensions.calculateSize(34) + (needDivider ? 1 : 0))
        );
