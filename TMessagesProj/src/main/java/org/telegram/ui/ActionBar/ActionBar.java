...
public class ActionBar extends FrameLayout {
    ...
    private static final int DEFAULT_TITLE_SIZE_DP = TelegramDimensions.getTitleTextSize();
    ...
    private int titleSizeDp = DEFAULT_TITLE_SIZE_DP;
    ...
    private void createBackButtonImage() {
        ...
        backButtonImageView.setId(R.id.actionbar_back_btn);
        backButtonImageView.setNextFocusLeftId(R.id.actionbar_back_btn);
        backButtonImageView.setNextFocusUpId(R.id.actionbar_back_btn);
        backButtonImageView.setScaleType(ImageView.ScaleType.CENTER);
        backButtonImageView.setBackgroundDrawable(Theme.createSelectorDrawable(getContext().getColor(R.color.sbdv_white_28), 1, TelegramDimensions.getActionBarRoundButtonSize()));
        if (itemsColor != 0) {
            backButtonImageView.setColorFilter(new PorterDuffColorFilter(itemsColor, colorFilterMode));
        }
        addView(backButtonImageView, LayoutHelper.createFrame(82, 54, Gravity.RIGHT | Gravity.TOP));
    ...
    public void setSubtitle(CharSequence value) {
        ...
        if (subtitleTextView != null) {
            ...
            subtitleTextView.setFocusable(false);
        }
    }
    ...
    private void createTitleTextView(int i) {
        ...
        titleTextView[i].setFocusable(false);
    ...
    public void setTitleTextSize(int titleSizeDp) {
        this.titleSizeDp = titleSizeDp;
        if (titleTextView[0] == null) {
            createTitleTextView(0);
        }
        titleTextView[0].setTextSize(this.titleSizeDp);
    }
...
//        }
    ...
    public void onSearchFieldVisibilityChanged(boolean visible) {
        ...
        backButtonImageView.setNextFocusRightId(visible ? R.id.actionbar_search_field : NO_ID);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (backButtonImageView != null && backButtonImageView.getVisibility() != GONE) {
            backButtonImageView.measure(MeasureSpec.makeMeasureSpec(dp(82), MeasureSpec.EXACTLY), actionBarHeightSpec);
        ...
        for (int i = 0; i < 2; i++) {
            if (titleTextView[0] != null && titleTextView[0].getVisibility() != GONE || subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
                ...
                if (titleTextView[i] != null && titleTextView[i].getVisibility() != GONE) {
                    titleTextView[i].setTextSize(titleSizeDp);
                }
                if (subtitleTextView != null && subtitleTextView.getVisibility() != GONE) {
                    subtitleTextView.setTextSize(titleSizeDp);
                }
