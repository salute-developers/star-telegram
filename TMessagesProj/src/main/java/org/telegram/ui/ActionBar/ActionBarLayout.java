...
public class ActionBarLayout extends FrameLayout implements INavigationLayout, FloatingDebugProvider {
    ...
    private static final String TAG = "ActionBarLayout";
...
//        }
    ...
    public void onBackPressed() {
        Log.d(TAG, "onBackPressed(). Fragment stack: " + (fragmentsStack == null ? null : fragmentsStack.toString()));
    ...
    @Override
    public void presentFragmentInternalRemoveOld(boolean removeLast, final BaseFragment fragment) {
        if (fragment == null) {
            return;
        }
...
//                layoutParams.topMargin += AndroidUtilities.dp(32);
    ...
    public boolean addFragmentToStack(BaseFragment fragment, int position) {
        Log.d(TAG, "addFragmentToStack(): " + fragment);
    ...
    public void bringToFront(int i) {
        ...
        containerView.setBackgroundResource(R.drawable.intro_frame_background);
        containerView.addView(fragmentView, LayoutHelper.createFrame(LayoutHelper.MATCH_PARENT, LayoutHelper.MATCH_PARENT));
        if (previousFragment.actionBar != null && previousFragment.actionBar.shouldAddToContainer()) {
            if (removeActionBarExtraHeight) {
                previousFragment.actionBar.setOccupyStatusBar(false);
