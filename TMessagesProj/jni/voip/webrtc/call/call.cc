...
Call::Stats Call::GetStats() const {
  ...
  if (!video_send_streams_.empty()) {
    const auto stream_stats = (*video_send_streams_.begin())->GetStats();

    stats.input_frame_rate = stream_stats.input_frame_rate;
    stats.encode_frame_rate = stream_stats.encode_frame_rate;
    stats.avg_encode_time_ms = stream_stats.avg_encode_time_ms;

    stats.frames_encoded = stream_stats.frames_encoded;
    stats.frames_dropped_by_capturer = stream_stats.frames_dropped_by_capturer;
    stats.frames_dropped_by_encoder_queue = stream_stats.frames_dropped_by_encoder_queue;
    stats.frames_dropped_by_rate_limiter = stream_stats.frames_dropped_by_rate_limiter;
    stats.frames_dropped_by_congestion_window = stream_stats.frames_dropped_by_congestion_window;
    stats.frames_dropped_by_encoder = stream_stats.frames_dropped_by_encoder;
  }
