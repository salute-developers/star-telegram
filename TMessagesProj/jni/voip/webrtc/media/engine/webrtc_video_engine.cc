...
WebRtcVideoChannel::WebRtcVideoSendStream::GetDegradationPreference() const {
  ...
  if (!enable_cpu_overuse_detection_) {
    RTC_LOG(LS_INFO) << "DegradationPreference is DISABLED";
  ...
  if (rtp_parameters_.degradation_preference.has_value()) {
    ...
    // It looks like it's the best option for StarGate
    ...
    if (parameters_.options.content_hint ==
      ...
      RTC_LOG(LS_INFO) << "GetDegradationPreference ContentHint::kFluid";
      ...
      RTC_LOG(LS_INFO) << "GetDegradationPreference hit default case";
  ...
  RTC_LOG(LS_INFO) << "GetDegradationPreference: " << degradation_preference;
